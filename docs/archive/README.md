...
Archived documents preserve rationale, provenance, and implementation evidence.
...
Do not silently rewrite historical intent. Add a clear current-authority note,
repair moved links, and put new requirements in an ADR, normative spec, roadmap,
or active plan. Current truth starts at [CURRENT-STATUS.md](../CURRENT-STATUS.md).
