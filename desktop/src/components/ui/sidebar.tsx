...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      {...props}
    >
      <PanelLeft className="cn-rtl-flip" data-icon="inline-start" />
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      className={cn(
        "cn-sidebar-rail absolute inset-y-0 z-20 hidden w-4 transition-[left,right,transform,background-color] ease-linear group-data-[side=left]:-right-4 group-data-[side=right]:left-0 after:absolute after:inset-y-0 after:start-1/2 after:w-[2px] sm:flex ltr:-translate-x-1/2 rtl:-translate-x-1/2",
